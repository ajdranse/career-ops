...
**In conflict, rules from `_profile.md` win over `_shared.md` defaults.** This is intentional: `_profile.md` is the user's personalization layer.
...
**Cross-cutting advantage**: Frame the candidate profile as a **"Technical builder"** who adapts their framing to the role:
...
- Reframe real experience with exact JD vocabulary
